      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left max-w-2xl">
            <p className="text-sm md:text-base font-medium text-primary mb-4 animate-fade-in-up opacity-0" style={{ animationDelay: '100ms', animationFillMode: 'forwards' }}>
              Hello, I'm
            </p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 animate-fade-in-up opacity-0" style={{ animationDelay: '200ms', animationFillMode: 'forwards' }}>
              <span className="gradient-text">Achintha</span>
              <br />
              <span className="text-foreground">Rathnayake</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-6 animate-fade-in-up opacity-0" style={{ animationDelay: '300ms', animationFillMode: 'forwards' }}>
              Computer Engineering Undergraduate | Web & AI Enthusiast
            </p>
            <p className="text-base md:text-lg text-muted-foreground/80 mb-8 max-w-lg mx-auto lg:mx-0 animate-fade-in-up opacity-0" style={{ animationDelay: '400ms', animationFillMode: 'forwards' }}>
              Passionate about solving real-world problems through innovative technology and AI-driven solutions.
            </p>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8 animate-fade-in-up opacity-0" style={{ animationDelay: '500ms', animationFillMode: 'forwards' }}>
              <Button
                size="lg"
                className="gradient-bg text-primary-foreground hover:opacity-90 transition-opacity glow-primary"
            ...
            {/* Social Links */}
            <div className="flex gap-4 justify-center lg:justify-start animate-fade-in-up opacity-0" style={{ animationDelay: '600ms', animationFillMode: 'forwards' }}>
              <a
          ...
          {/* Profile Image */}
          <div className="flex-shrink-0 animate-fade-in-up opacity-0" style={{ animationDelay: '300ms', animationFillMode: 'forwards' }}>
            <div className="relative">
              ...
              <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full gradient-border p-1">
                <div className="w-full h-full rounded-full overflow-hidden">
                  <img
                    src={profilePhoto}
                    alt="Achintha Rathnayake - Computer Engineering Student"
